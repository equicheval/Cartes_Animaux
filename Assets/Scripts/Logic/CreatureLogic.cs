...
public class CreatureLogic: ICharacter 
{
    ...
    {
        this.ca = ca;
        baseHealth = ca.VieMaximum;
        Health = ca.VieMaximum;
        baseAttack = ca.Attaque;
        attacksForOneTurn = ca.NombreAttaqueParTour;
        ...
        {
			effect = System.Activator.CreateInstance(System.Type.GetType(ca.CreatureScriptName), new System.Object[]{owner, this, ca.specialCreatureAmount, ca.specialCreatureName}) as CreatureEffect;
